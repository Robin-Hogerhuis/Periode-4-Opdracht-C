...
namespace Domotica
{
    ...
    public class MainActivity : Activity
    {
        ...
        // Controls on GUI
        SeekBar seekBar1;
        Button buttonConnect, buttonChangePinState, buttonRf1;
        TextView textViewServerConnect, textViewTimerStateValue;
        public TextView textViewChangePinStateValue, textViewSensorValue, textViewSensorValue2, textViewDebugValue, textViewRF1;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            commandList.Add(new Tuple<string, TextView>("3", textViewRF3));*/
            ...
            if (buttonRf1 != null && seekBar1 != null)
            {
                buttonRf1.Click += (sender, e) =>
                {
                    UpdateGUI(executeCommand("o"), textViewRF1);               // Send command to open or close the barrier
                };

                seekBar1.ProgressChanged += (sender, e) =>
                {
                    var distance = Convert.ToString(e.Progress);
                    executeCommand(distance);
                    textViewSensorValue2.Text = distance; 
                };
            }
        }
